...
import OrtografiaChips from './OrtografiaChips';
                    ...
                    <Container maxWidth="md">
                        ...
                        <Grid container spacing={1}>
                            <Grid item md={6} xs={12} spacing={1}>
                                <OrtografiaChips key="correctWords" title="✔️ Correctas" items={correctWords} onNoItemsSeverity="error" onNoItemsAlert="Oops! No tuviste palabras correctas :(" />
                            </Grid>
                            <Grid item md={6} xs={12} spacing={1}>
                                <OrtografiaChips key="incorrectWords" title="❌ Incorrectas" items={incorrectWords} onNoItemsSeverity="success" onNoItemsAlert="Muy bien! Acertaste todas las palabras!" />
                            </Grid>
                        </Grid>
